window.COURSEBUILD_SAMPLE = {
  ...
  items: [
    { id:"i1", moduleId:"m1", type:"Page", title:"Why platforms matter", purpose:"Introduce the module and connect it to daily digital behavior.", points:0, status:"Planned", draftHtml:"", canvasUrl:"" },
    { id:"i2", moduleId:"m1", type:"Discussion", title:"Who controls your attention?", purpose:"Analyze one platform design choice and its effect on behavior.", points:10, status:"Planned", draftHtml:"", canvasUrl:"" },
    { id:"i3", moduleId:"m2", type:"Assignment", title:"Credibility check", purpose:"Evaluate the credibility of a digital claim using evidence.", points:25, status:"Planned", draftHtml:"", canvasUrl:"" }
  ],
  versions: [
